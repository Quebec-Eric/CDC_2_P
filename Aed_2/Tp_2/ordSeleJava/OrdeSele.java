...
public class OrdeSele {
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			ordenacaoSele(saidas, y); /* ajustar para fazer o QuicksortParc */
	...
	public static void ordenacaoSele(String[] saidas, int y) {
	...
	public static List<String> pegarNomesArtistar(String linha) {
		...
		if (tirarVirgula.length > 1) {
			...
			if (tirarVirgula[0].charAt(0) == tt
					&& tirarVirgula[0].charAt(1) == tt) {/* teste para verificar se existe erros na linhas */
	...
	public static String localizarPegar(String linha) {
		int inicioaSerCortado = linha.indexOf("]");
		inicioaSerCortado = linha.indexOf("#", inicioaSerCortado + 1);
		int fimaSerCortado = linha.indexOf("#", inicioaSerCortado + 2);
		String nomes = linha.substring(inicioaSerCortado + 2, fimaSerCortado - 2);
		return nomes;
	}
}
