...
public void ImprimeNosInternosPosOrdem(No no) {
   ...
   public int getAltura(int procurar){
		 No eric= pesquisar(procurar);
		 System.out.println(eric.elemento);

		 int primeiroT= getAltura(eric, 0);
		 int segundoT=getAltura(raiz,0);
		 return (segundoT-primeiroT)-1;
   }
